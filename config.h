...
static const char dmenufont[]       = "Hack Nerd Font:style=Regular:size=10:antialias=true:autohint=true";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_cyan, "#3e4451",  col_cyan  },
};
...
static const Key keys[] = {
	...
	{ 0,                            XK_Print,  spawn,          SHCMD("~/.local/bin/rofi-screenshot") },
	{ Mod1Mask|ControlMask,         XK_Delete, spawn,          SHCMD("~/.local/bin/rofi-power-menu") },
